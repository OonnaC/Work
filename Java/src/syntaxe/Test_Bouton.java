...
public class Form1 extends Form
{
	...
	*/
	...
	/*** REMARQUE : le code suivant est requis par le Concepteur de feuilles * Visual J++. Il est possible de le modifier à l'aide de l'éditeur de        * feuilles. N'utilisez pas l'éditeur de code pour effectuer cette        * modification.*/
