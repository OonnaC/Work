<?php
    ...
    if ($result)
        echo "<meta http-equiv='refresh' content='0;url=AC11.php?message=<font color=green> Modification realisee ! </font>'>";
        else
            echo "<meta http-equiv='refresh' content='0;url=AC11.php?message=<font color=red> Probleme de modification ... </font>'>";
?>
