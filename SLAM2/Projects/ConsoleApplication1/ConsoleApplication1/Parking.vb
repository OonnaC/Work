Public Class Parking
    ...
    Private Sub afficheConsoleplacesoccupees()
        Console.WriteLine("Nombre de places occupées : " & Me.PlacesOccupees.ToString)
    End Sub
    ...
    Public Sub New()
        'Me.Nom = String.Parse(Microsoft.VisualBasic.Interaction.InputBox("Entrer nom du parking: "))
        Me.PlacesLibres = Integer.Parse(Microsoft.VisualBasic.Interaction.InputBox("Entrer le nombre de places libres:"))
        Me.PlacesOccupees = 0
    End Sub
