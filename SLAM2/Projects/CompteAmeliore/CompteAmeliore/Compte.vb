...
refaire:
    ...
    End Sub
    Public Sub New(ByVal soldeInitial As Integer)
        Me.mesOperations = New List(Of Operation)
...
refaire:
    ...
    Public Sub depot(ByVal uneSomme As Integer, ByVal unLibelle As String)
        ...
        Dim uneOperationTemp As New Operation(TypeOperation.Depot, unLibelle, uneSomme)
    ...
    Public Overridable Sub retrait(ByVal uneSomme As Integer)
        Me.soldeActuel -= uneSomme
    End Sub
    Public Sub retrait(ByVal uneSomme As Integer, ByVal unLibelle As String)
        Me.retrait(uneSomme)

        Dim uneOperationTemp As New Operation(TypeOperation.Retrait, unLibelle, uneSomme)
        Me.mesOperations.Add(uneOperationTemp)
    End Sub

    Public Overridable Sub retrait(ByVal uneSomme As Integer, ByVal unLibelle As String, ByVal uneDate As Date)
    ...
    '    Console.WriteLine(Me._numeroCompte.ToString)
    '    Console.WriteLine(Me._soldeActuel.ToString)

    '    For Each Operation As Operation In Me.mesOperations
