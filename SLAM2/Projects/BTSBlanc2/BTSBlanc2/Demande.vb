Public Class Demande
    ...
    Public Property DateDemande() As Date
        ...
        End Set
    End Property
    Public Property LocaliteDemande() As String
        Get
        ...
        End Set
    End Property
    Public Property AvisDemande As EnumAvis
        Get
            Return Me._AvisDemande
        End Get
        Set(ByVal value As EnumAvis)
    ...
    Sub New(ByVal unId As Integer, ByVal uneDate As Date, ByVal uneLocalite As String, ByVal unAvis As EnumAvis)
        Me.IdDemande = unId
        Me.DateDemande = uneDate
        Me.LocaliteDemande = uneLocalite
        Me.AvisDemande = unAvis
    End Sub
